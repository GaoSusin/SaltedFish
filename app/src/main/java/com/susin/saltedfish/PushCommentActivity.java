...
import com.susin.saltedfish.model.Commentator;
import com.susin.saltedfish.net.Request4PushComment;
import com.susin.saltedfish.net.Request4PushFreshComment;
import com.susin.saltedfish.utils.EditTextShakeHelper;
import com.susin.saltedfish.utils.SharedPreUtils;
...
public class PushCommentActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        tv_title.setText(UtilText.isEmptyOrNull(parent_name) ? "回复:" : "回复:" + parent_name);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_push:
                ...
                if (UtilText.isEmptyOrNull(message)) {
                        ...
                        .callback(new MaterialDialog.ButtonCallback() {
                            ...
                            public void onPositive(final MaterialDialog dialog) {
                                ...
                                if (thread_id.length() == 5) {
                                    String url;
                                    //回复别人 和首次评论
                                    if (!UtilText.isEmptyOrNull(parent_id) && !UtilText.isEmptyOrNull(parent_name)) {
                                ...
                                //回复别人 和首次评论
                                if (!UtilText.isEmptyOrNull(parent_id)) {
    ...
    private class InputWatcher implements TextWatcher {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            positiveAction.setEnabled(UtilText.isEmail(et_email.getText().toString().trim()
            ) && !UtilText.isEmptyOrNull(et_name.getText().toString()));
        }
