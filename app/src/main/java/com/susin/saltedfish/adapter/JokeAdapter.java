...
import com.susin.saltedfish.model.Joke;
import com.susin.saltedfish.net.JSONParser;
import com.susin.saltedfish.net.Request4CommentCounts;
import com.susin.saltedfish.net.Request4Joke;
                        ...
                        .itemsCallback(new MaterialDialog.ListCallback() {
                            ...
                            public void onSelection(MaterialDialog dialog, View view, int which, CharSequence text) {
                                ...
                                switch (which) {
                                    ...
                                    //复制
                                    case 1:
                                        UtilText.copy(mActivity, joke.getComment_content());
                                        break;
                                }
